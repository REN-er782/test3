...
if is_spouse == "はい":
    ...
    if income_high == "1,000万円以上":
        st.info("")
        result_map = {
            "年収：123万円以下":  ("❌ 控除対象外", "✅ 健保の被扶養者対象", "✅ 家族手当支給"),
            "年収：123万円超〜130万円未満": ("❌ 控除対象外", "✅ 健保の被扶養者対象", "✅ 家族手当支給"),
            "年収：130万円超〜160万円未満": ("❌ 控除対象外", "❌ 健保の被扶養者対象外", "✅ 家族手当支給"),
            "年収：160万円超〜201万円未満": ("❌ 控除対象外", "❌ 健保の被扶養者対象外", "❌ 家族手当不支給"),
            "年収：201万円超":  ("❌ 控除対象外", "❌ 健保の被扶養者対象外", "❌ 家族手当不支給"),
        }
    else:
        result_map = {
            "年収：123万円以下":  ("✅ 配偶者控除対象", "✅ 健保の被扶養者対象", "✅ 家族手当支給"),
            "年収：123万円超〜130万円未満": ("✅ 配偶者特別控除対象", "✅ 健保の被扶養者対象", "✅ 家族手当支給"),
            "年収：130万円超〜160万円未満": ("✅ 配偶者特別控除対象", "❌ 健保の被扶養者対象外", "✅ 家族手当支給"),
            "年収：160万円超〜201万円未満": ("✅ 配偶者特別控除対象（段階的）", "❌ 健保の被扶養者対象外", "❌ 家族手当不支給"),
            "年収：201万円超":  ("✅ 配偶者特別控除対象（段階的）", "❌ 健保の被扶養者対象外", "❌ 家族手当不支給"),
        }
...
- ✅ 家族手当支給（※社内規定による）""")
    ...
    if age_group == "19〜22歳（特定扶養親族）":
        result_map = {
            "年収：123万円以下": ("✅ 控除対象", "✅ 健保の被扶養者対象", "✅ 家族手当支給"),
            "年収：123万円超〜130万円未満": ("✅ 控除対象", "✅ 健保の被扶養者対象", "✅ 家族手当支給"),
            "年収：130万円超〜160万円未満": ("✅ 控除対象", "❌ 健保の被扶養者対象外", "✅ 家族手当支給"),
            "年収：160万円超〜188万円未満": ("✅ 控除対象（段階的）", "❌ 健保の被扶養者対象外", "❌ 家族手当不支給"),
            "年収：188万円超": ("❌ 控除対象外", "❌ 健保の被扶養者対象外", "❌ 家族手当不支給")
        }
    else:
        result_map = {
            "年収：123万円以下": ("✅ 控除対象", "✅ 健保の被扶養者対象", "✅ 家族手当支給"),
            "年収：123万円超〜130万円未満": ("❌ 控除対象外", "✅ 健保の被扶養者対象", "✅ 家族手当支給"),
            "年収：130万円超〜160万円未満": ("❌ 控除対象外", "❌ 健保の被扶養者対象外", "✅ 家族手当支給"),
            "年収：160万円超〜188万円未満": ("❌ 控除対象外", "❌ 健保の被扶養者対象外", "❌ 家族手当不支給"),
            "年収：188万円超": ("❌ 控除対象外", "❌ 健保の被扶養者対象外", "❌ 家族手当不支給")
        }
