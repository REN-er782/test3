...
- ✅ 家族手当支給（※社内規定による）""")
    ...
    income_child = st.selectbox("対象者の年間所得（目安）", [
        "～123万円",
        "123万円超～130万円",
        "130万円超～160万円",
        "160万円超～188万円",
    ...
    if age_group == "19〜22歳（特定扶養親族）":
        result_map = {
            "～123万円": ("✅ 控除対象", "✅ 健保の被扶養者対象", "✅ 家族手当支給"),
            "123万円超～130万円": ("✅ 控除対象", "✅ 健保の被扶養者対象", "✅ 家族手当支給"),
            "130万円超～160万円": ("✅ 控除対象", "❌ 健保の被扶養者対象外", "✅ 家族手当支給"),
            "160万円超～188万円": ("✅ 控除対象（段階的）", "❌ 健保の被扶養者対象外", "❌ 家族手当不支給"),
            "188万円超": ("❌ 控除対象外", "❌ 健保の被扶養者対象外", "❌ 家族手当不支給")
        }
    else:
        result_map = {
            "～123万円": ("✅ 控除対象", "✅ 健保の被扶養者対象", "✅ 家族手当支給"),
            "123万円超～130万円": ("❌ 控除対象外", "✅ 健保の被扶養者対象", "✅ 家族手当支給"),
            "130万円超～160万円": ("❌ 控除対象外", "❌ 健保の被扶養者対象外", "✅ 家族手当支給"),
            "160万円超～188万円": ("❌ 控除対象外", "❌ 健保の被扶養者対象外", "❌ 家族手当不支給"),
            "188万円超": ("❌ 控除対象外", "❌ 健保の被扶養者対象外", "❌ 家族手当不支給")
        }
